		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Aarini Demo Repository",
									"targetURL": "#aarinidemoappsaarinidemoapps-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"aarinidemoappsaarinidemoapps-display": {
								"semanticObject": "aarinidemoappsaarinidemoapps",
								"action": "display",
								"description": "Aarini Demo Repository",
								"title": "Aarini Demo Repository",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=aarinidemoapps.aarinidemoapps",
									"url": sap.ui.require.toUrl("aarinidemoapps/aarinidemoapps")
								}
							}
						}
					}
